...
tOperation: CREATE TABLE ID LPARENT columna (CONSTRAINT constraint (COMMA CONSTRAINT constraint)*)? (COMMA columna (CONSTRAINT constraint (COMMA CONSTRAINT constraint)*)?)* RPARENT #crearTB
